  ...
  return (
    <>
      ...
      <div className="topTwoButtons flex justify-center">
          <ButtonHero intent="outline" routerPath={'/OpenWallet/ExistingWalletOptions'} padding="pt-6 p-10">
            <div className="inline-grid justify-center m-10 scale-370">
              <CiViewTimeline />
            </div>
            <h1 className="font-bold text-xl">Import from seed phrase</h1>
          </ButtonHero>
          <ButtonHero intent="outline" routerPath={'/NewWallet/StepOne'} padding="pt-6 p-10">
            <div className="inline-grid justify-center m-10 scale-370">
              <LuFileKey2 />
            </div>
