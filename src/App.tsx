    ...
    <>
      <div className="block justify-center overflow-hidden gap-2">
        <div className="text-center">
          ...
          <h1 className="font-roboto text-primary-500 text-6xl tracking-logo grid justify-center my-8">
            Hash Vault
          </h1>
        </div>
        <div className="bothButtons flex justify-center">
          <ButtonHero intent='outline'>
            <div className="inline-grid justify-center m-1 scale-300">
              <PiDownloadSimple className="mb-1">
              </PiDownloadSimple>
            </div>
            ...
            <p className="text-base max-w-xs">
              Already have a wallet? Import it using your seed phrase or encrypted keystore file.
            </p>
          </ButtonHero>
          <ButtonHero intent='solid'>
            <div className="inline-grid justify-center m-1 scale-300">
              <MdOutlineLibraryAdd className="mb-1">
              </MdOutlineLibraryAdd>
            </div>
            <h1 className='font-bold m-3 text-xl'>
              Create a new wallet
            ...
            <p className="text-base max-w-xs">
              New to Hash Vault? Let&#39;s set it up! This will create a new wallet and seed phrase.
            </p>
          </ButtonHero>
        </div>
        <div className="flex justify-center place-items-center">
          <hr className="border-primary-500 w-32 m-3"/>
          <h2 className="text-primary-500 grid justify-center">
            or
          </h2>
          <hr className="border-primary-500 w-32 m-3"/>
        </div>
