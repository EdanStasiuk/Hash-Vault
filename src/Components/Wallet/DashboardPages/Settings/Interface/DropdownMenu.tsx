...
export default function DropdownMenu({ currencyTypes }: Props): JSX.Element {
  return (
    <div className="dropdown">
      <select id="currency-select" className="border border-primary-500 bg-background-500 rounded-lg w-[68px] h-8 text-white font-robotoFlex font-thin text-xl text-center pl-1">
